...
namespace Payment_Client
{
    ...
    public class Register
    {
        ...
        /// </summary>
        public static string RegisterDevice(string name, string institutionSin, string entity_sin, string token, string jwtSecurityToken)
        {
            ...
            {
                // Generate OTP shared
                byte[] accountCodebytes = KeyGeneration.GenerateRandomKey();
                record.otp_shared_secret = Base32Encoding.ToString(accountCodebytes);
                var totp = new Totp(accountCodebytes);
                record.token = totp.ComputeTotp();
            ...
            // JwtSecurityToken registration authorization
            _httpClient.DefaultRequestHeaders.Add("x-authorization", jwtSecurityToken);
